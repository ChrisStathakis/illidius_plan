...
ALLOWED_HOSTS = ['127.0.0.1', 'simply-chris.com', 'www.simply-chris.com', 'plankton-app_-32pmz.ondigitalocean.app_']
...
AWS_S3_CUSTOM_DOMAIN = '%s.s3.amazonaws.com' % AWS_STORAGE_BUCKET_NAME
    ...
    # Tell the staticfiles app_ to use S3Boto storage when writing the collected static files (when
